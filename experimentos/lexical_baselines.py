...
# --dataset / --out allow running the same baselines on Biblio-VSE v2 (N=96).
def _arg(flag, default):
    return sys.argv[sys.argv.index(flag) + 1] if flag in sys.argv else default


DATASET = os.path.abspath(_arg("--dataset", os.path.join(_ROOT, "dataset_isomorfico.json")))
OUT_PATH = os.path.abspath(_arg("--out", os.path.join(_DIR, "lexical_baselines_n32.json")))
