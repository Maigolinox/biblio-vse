# EXPERIMENT 7 — RAG + ACTIVATION STEERING
# Retrieved normative context + neural steering vector.
# No structured zero-shot.
import json, os, sys
...
def main():
    print(f"\n{'#'*70}")
    print(f"  {NOMBRE}")
    print(f"  RAG corpus={RAG_CORPUS} + steering α={ALPHA}  lang={LANG}")
    print(f"{'#'*70}")
