# EXPERIMENT 4 — ACTIVATION STEERING (only)
# Minimal prompt with basic system instruction + neural steering vector.
# No structured zero-shot, no RAG. Isolates the steering effect.
import json, os, sys
...
from utils import (
    ...
    formatear_prompt, prompt_basico, imprimir_resultados,
    aplicar_steering,
)
