...
LOG_MAIN = os.path.join(_ROOT, "resultados", "n32", "resultados_conglomerados_actualizados_03062026.txt")
LOG_ES = os.path.join(_ROOT, "resultados", "n32", "resultados_new_layer.txt")
